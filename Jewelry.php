  ...
  if(isset($_POST['add'])){
    ...
    if(isset($_SESSION['cart'])){
      ...
      if(in_array($_POST['product_id'], $items_id)){
        ...
        echo"<script>window.location = 'Jewelry.php'</script>";
        // printf('ddd');
      }else {
    ...
    <div  align="center">
      ...
      <div class="menu">
        ...
        <div class="catagory">
         ...
         <?php
         $sql = "SELECT * FROM product WHERE product_type = 'jewelry'; ";
         ...
         while($row = mysqli_fetch_assoc($result)){
                   ...
                   productjewelry($productname,$productprice,$productdetails,$productimage,$productid);
           }
         ?>
