      ...
      <div class="menu">
        ...
        <div class="catagory">
         ...
         while($row = mysqli_fetch_assoc($result)){
                   ...
                   productshirt($productname,$productprice,$productdetails,$productimage,$productid);
           }
         ?>
         </div>
        <!-- <div class="catagory">
         ...
         <br><br>
         <div class="card">
           <img src="image/Men/Shirt/Shirt1.jpg" alt="L.L.Bean" style="width:100%">
           <h1>L.L.Bean</h1>
           <p class="price">1500 BDT</p>
           <p>Wrinkle-Free sheck shirt. Traditional fits short sleeve.</p>
           <p><button>Add to Cart</button></p>
         </div>

         <div class="card">
           <img src="image/Men/Shirt/Shirt2.jpg" alt="Banana Republic" style="width:100%">
           <h1>Banana Republic</h1>
           <p class="price">1650 BDT</p>
           <p>Slim-Fit Tech-Stretch cotton shirt.</p>
           <p><button>Add to Cart</button></p>
         </div>

         <div class="card">
           <img src="image/Men/Shirt/Shirt3.jpg" alt="Club Room" style="width:100%">
           <h1>Club Room</h1>
           <p class="price">1350 BDT</p>
           <p>Men's Big & Tall classic regular fit stretch double Gingham shirt.</p>
           <p><button>Add to Cart</button></p>
         </div>

         <div class="card">
           <img src="image/Men/Shirt/Shirt4.jpg" alt="Jos.A.Bank" style="width:100%">
           <h1>Jos.A.Bank</h1>
           <p class="price">1580 BDT</p>
           <p>Traveler buttondown large tartan check spotshirt with full sleeves.</p>
           <p><button>Add to Cart</button></p>
         </div>

         <div class="card">
           <img src="image/Men/Shirt/Shirt5.jpg" alt="Jos.A.Bank" style="width:100%">
           <h1>Jos.A.Bank</h1>
           <p class="price">1550 BDT</p>
           <p>Traveler long sleeve patterned cotton buttondown spotshirt.</p>
           <p><button>Add to Cart</button></p>
         </div>

         <div class="card">
           <img src="image/Men/Shirt/Shirt6.jpg" alt="JC Penney" style="width:100%">
           <h1>JC Penney</h1>
           <p class="price">1800 BDT</p>
           <p>Stafford travel Wf stretch oxford shirt. Button down collar & long sleeve.</p>
           <p><button>Add to Cart</button></p>
         </div>

         <div class="card">
           <img src="image/Men/Shirt/Shirt7.jpg" alt="L.L.Bean" style="width:100%">
           <h1>L.L.Bean</h1>
           <p class="price">1900 BDT</p>
           <p>Wrinkle-Free classic oxford cloth shirt with full sleeve.</p>
           <p><button>Add to Cart</button></p>
         </div>

         <div class="card">
           <img src="image/Men/Shirt/Shirt8.jpg" alt="L.L.Bean" style="width:100%">
           <h1>L.L.Bean</h1>
           <p class="price">1900 BDT</p>
           <p>Wrinkle-Free classic oxford cloth shirt with full sleeve.</p>
           <p><button>Add to Cart</button></p>
