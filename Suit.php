  ...
  if(isset($_POST['add'])){
    ...
    if(isset($_SESSION['cart'])){
      ...
      if(in_array($_POST['product_id'], $items_id)){
        ...
        echo"<script>window.location = 'Suit.php'</script>";
        // printf('ddd');
      }else {
    ...
    <div  align="center">
      ...
      <div class="menu">
        ...
        <div class="catagory">
         ...
         <?php
         $sql = "SELECT * FROM product WHERE product_type = 'suit'; ";
         ...
         while($row = mysqli_fetch_assoc($result)){
                   ...
                   productsuit($productname,$productprice,$productdetails,$productimage,$productid);
           }
         ?>
         </div>
        <!-- <div class="catagory">
         ...
         <br><br>
         <div class="card">
           <img src="image/Men/Suit/Suit1.jpg" alt="Burberry" style="width:100%">
           <h1>Burberry</h1>
           <p class="price">20000 BDT</p>
           <p>Men's Suits & Tuxedos.</p>
           <p><button>Add to Cart</button></p>
         </div>

         <div class="card">
           <img src="image/Men/Suit/Suit2.jpg" alt="Burberry" style="width:100%">
           <h1>Burberry</h1>
           <p class="price">20000 BDT</p>
           <p>Men's Suits & Tuxedos.</p>
           <p><button>Add to Cart</button></p>
         ...
         <div class="card">
           <img src="image/Men/Suit/Suit3.jpg" alt="Burberry" style="width:100%">
           <h1>Burberry</h1>
           <p class="price">20000 BDT</p>
           <p>Men's Suits & Tuxedos.</p>
           <p><button>Add to Cart</button></p>
         ...
         <div class="card">
           <img src="image/Men/Suit/Suit4.jpg" alt="Burberry" style="width:100%">
           <h1>Burberry</h1>
           <p class="price">20000 BDT</p>
           <p>Men's Suits & Tuxedos.</p>
           <p><button>Add to Cart</button></p>
         ...
         <div class="card">
           <img src="image/Men/Suit/Suit5.jpg" alt="Burberry" style="width:100%">
           <h1>Burberry</h1>
           <p class="price">20000 BDT</p>
           <p>Men's Suits & Tuxedos.</p>
           <p><button>Add to Cart</button></p>
         ...
         <div class="card">
           <img src="image/Men/Suit/Suit6.jpg" alt="Burberry" style="width:100%">
           <h1>Burberry</h1>
           <p class="price">20000 BDT</p>
           <p>Men's Suits & Tuxedos.</p>
           <p><button>Add to Cart</button></p>
         ...
         <div class="card">
           <img src="image/Men/Suit/Suit7.jpg" alt="Burberry" style="width:100%">
           <h1>Burberry</h1>
           <p class="price">20000 BDT</p>
           <p>Men's Suits & Tuxedos.</p>
           <p><button>Add to Cart</button></p>
         ...
         <div class="card">
           <img src="image/Men/Suit/Suit8.jpg" alt="Burberry" style="width:100%">
           <h1>Burberry</h1>
           <p class="price">20000 BDT</p>
           <p>Men's Suits & Tuxedos.</p>
           <p><button>Add to Cart</button></p>
