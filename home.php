...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="main" align="center">
      ...
      <div class="menu" >
        <!-- <p class="catagory_type" onclick="openForm()">Mens</p> -->
        ...
        <?php openWomens() ?>
        <!-- openWomens -->
        <!-- <a href="womens_catagory.php" class="catagory_type" >Womens</a> -->
        <!-- <a href="kids_catagory.php" class="catagory_type" >Kids</a> -->
       ...
       <section id="slider_section">
    		<div class="container">
    			...
    			<div class="slider_text">
    				<h1><br />e l e g a n z a</h1>
    				<p>A trusted online shoping shop</p>
    			</div>
    		</div>
	   </section>
     <br>
    ...
    <div class="Product_container">
      ...
      <a href="Shirt.php"><img src="image/men/shirt/Shirt2.jpg" width="350" height="443" alt=""></a>
        <span>Shirt</span>
      </div>
      <div class="catagory-box">
      ...
      <div class="catagory-box">
      <a href="Suit.php"><img src="image/men/suit/Suit1.jpg" width="350" height="443" alt=""></a>
        <span>Suit</span>
      </div>
      <div class="catagory-box">
